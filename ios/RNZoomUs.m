...
- (void)setMeetingSettings {
    ...
    if (zoomSettings != nil) {
        ...
        [zoomSettings disableShowVideoPreviewWhenJoinMeeting: TRUE];
        [zoomSettings disableMinimizeMeeting:disableMinimizeMeeting];
        [zoomSettings disableClearWebKitCache:disableClearWebKitCache];
        [zoomSettings setMuteAudioWhenJoinMeeting: FALSE];
        [zoomSettings setMuteVideoWhenJoinMeeting: FALSE];
    }
}
...
- (void)onMeetingStateChange:(MobileRTCMeetingState)state {
    ...
    [self onVNTelMeetingStateChange: state];
...
- (void)onSinkMeetingVideoStatusChange:(NSUInteger)userID videoStatus:(MobileRTC_VideoStatus)videoStatus {
    [self onVNTelSinkMeetingVideoStatusChange:userID videoStatus:videoStatus];
    MobileRTCMeetingService *ms = [[MobileRTC sharedRTC] getMeetingService];
...
- (void)onSinkMeetingVideoRequestUnmuteByHost:(void (^)(BOOL Accept))completion {
    [self onVNTelSinkMeetingVideoRequestUnmuteByHost:completion];
...
- (void)onSinkMeetingActiveVideo:(NSUInteger)userID {
    [self onVNTelSinkMeetingActiveVideo:userID];
}


- (void)onSinkMeetingVideoStatusChange:(NSUInteger)userID {
    [self onVNTelSinkMeetingVideoStatusChange: userID];
}

- (void)onMyVideoStateChange {
    [self onVNTelMyVideoStateChange];
}

- (void)onSpotlightVideoChange:(BOOL)on {}

- (void)onSinkMeetingPreviewStopped {
    [self onVNTelSinkMeetingPreviewStopped];
}
